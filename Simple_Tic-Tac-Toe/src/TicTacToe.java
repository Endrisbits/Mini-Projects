class TicTacToe {
    ...
    public boolean validMove(int x, int y) { //inputs x and y from (1-3)
        int i=x-1; int j=y-1;
    ...
    private TicTacToe.FieldValues[] gameField = new FieldValues[] {
    ...
    private GameState m_gameState = GameState.NOT_FINISHED;

    private void setFieldFromString(String cells) {
    ...
    private  boolean checkWin(FieldValues v) {
    ...
    private  Turn m_currentTurn = Turn.PLAYER_X;
}
